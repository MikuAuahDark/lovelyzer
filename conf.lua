...
local AquaShine = assert(love.filesystem.load("AquaShine.lua"))({
	Entries = {
		...
		main = {1, "start_visualizer.lua"}
	},
	DefaultEntry = "main",
	Width = 1280,	-- Letterboxing
	Height = 720	-- Letterboxing
})
...
function love.conf(t)
	t.identity = "lovelyzer"                      -- The name of the save directory (string)
	...
	t.window.width = gcfgn("width", 1024)         -- The window width (number)
	t.window.height = gcfgn("height", 576)        -- The window height (number)
